...
import { TrackedJob, User, TrackedJobPriority, TrackedJobStatus, TaskColumn, TaskGroup, InvoiceLineItem } from '../types';
...
const JobBoard: React.FC<JobBoardProps> = ({ 
    jobs, onUpdateJob, onCreateJob, onCreateQuoteFromJobs, users, currentUser, taskColumns, setTaskColumns,
